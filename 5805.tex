...
\toprule
& & 
\multicolumn{3}{c}{Remove gross polluters \tabularnewline(above 179 dB threshold)} & 
\multicolumn{3}{c}{Quiet gross polluters \tabularnewline(to 175.4 dB threshold)} \tabularnewline
\endhead
